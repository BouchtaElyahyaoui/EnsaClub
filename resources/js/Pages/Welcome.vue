  ...
  <div class="iq-top-navbar">
    <div class="iq-navbar-custom">
      <nav class="navbar navbar-expand-lg navbar-light p-0">
        ...
        <div v-if="canLogin" class="collapse navbar-collapse" id="navbarSupportedContent">
          <div v-if="$page.props.user">
            <ul class="navbar-nav ml-auto navbar-list">
              <li>
                <a href="profile.html" class="iq-waves-effect d-flex align-items-center">
                  <img :src="'/storage/assets/images/user/1.jpg'" class="img-fluid rounded-circle mr-3" alt="user">
                  <div class="caption">
          ...
          <div v-else>
            <ul class="navbar-nav ml-auto navbar-list">
              <Link :href="route('login')" class="mx-3">Login</Link>
              <Link v-if="canRegister" class="mx-3" :href="route('register')">
              Register
              </Link>
            </ul>
