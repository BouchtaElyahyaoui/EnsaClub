    ...
    <template #form>
      ...
      <div class="mb-3" v-if="$page.props.jetstream.managesProfilePhotos">
        ...
        <div class="mt-2" v-show="!photoPreview">
          <img :src="user.profile_photo_url" alt="Current Profile Photo" class="img-fluid rounded-circle">
        </div>
      ...
      <div class="w-75">
        ...
        <div class="mb-3">
          ...
          <jet-input id="username" type="text" v-model="form.username" :class="{ 'is-invalid': form.errors.username }"
            autocomplete="username" />
          <jet-input-error :message="form.errors.username" />
        </div>

        <!-- Gender -->

        <div class="mb-3">
          <jet-label for="gender" value="Gender">Gender</jet-label>
