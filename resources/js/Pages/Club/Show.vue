                                ...
                                <div class="friend-list-tab mt-2">
                                    <div class="tab-content">
                                        <div class="tab-pane fade active show" id="all-friends" role="tabpanel">
                                            <div class="iq-card-body p-0">
                                                <div class="row">
                                                    <div class="col-md-6 col-lg-6 mb-3" v-for="(user,key) in club.users"
                                                        :key="key">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="friend-info ml-3">
                                                                        <h5>
                                                                            {{user.username}}</h5>
                                                                        <p v-if="user.pivot.role_id == 1" class="mb-0">
                                                                            President(e) </p>
                                                                        <p v-else-if="user.pivot.role_id == 2"
                                                                            class="mb-0">
                                                                            Vice President(e) </p>
                                                                        ...
                                                                        <p v-else-if="user.pivot.role_id == 9" class="
                                                                            mb-0">
                                            ...
                                            <div class="iq-card-body p-0">
                                                <div class="row">
                                                    <div class="col-md-6 col-lg-3 mb-3"
                                                        v-for="(image , indice) in club_images" :key="indice">
...
export default {
    props: ['club', 'posts', 'club_images'],
    components: {
        PagesLayout, CombPosts, PostForm, InfiniteScroll, Link
    },
    data() {
