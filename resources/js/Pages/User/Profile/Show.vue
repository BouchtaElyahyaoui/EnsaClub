                                            ...
                                            <ul class="profile-img-gallary d-flex flex-wrap p-0 m-0">
                                                <li class="col-md-4 col-6 pl-2 pr-0 pb-3"><a
                                                        href="javascript:void();"><img
                                                            :src="'/storage/assets/images/page-img/g1.jpg'"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class="col-md-4 col-6 pl-2 pr-0 pb-3"><a
                                                        href="javascript:void();"><img
                                                            :src="'/storage/assets/images/page-img/g2.jpg'"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class="col-md-4 col-6 pl-2 pr-0 pb-3"><a
                                                        href="javascript:void();"><img
                                                            :src="'/storage/assets/images/page-img/g3.jpg'"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class="col-md-4 col-6 pl-2 pr-0 pb-3"><a
                                                        href="javascript:void();"><img
                                                            :src="'/storage/assets/images/page-img/g4.jpg'"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class="col-md-4 col-6 pl-2 pr-0 pb-3"><a
                                                        href="javascript:void();"><img
                                                            :src="'/storage/assets/images/page-img/g5.jpg'"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class="col-md-4 col-6 pl-2 pr-0 pb-3"><a
                                                        href="javascript:void();"><img
                                                            :src="'/storage/assets/images/page-img/g6.jpg'"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class="col-md-4 col-6 pl-2 pr-0 pb-0"><a
                                                        href="javascript:void();"><img
                                                            :src="'/storage/assets/images/page-img/g7.jpg'"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class="col-md-4 col-6 pl-2 pr-0 pb-0"><a
                                                        href="javascript:void();"><img
                                                            :src="'/storage/assets/images/page-img/g8.jpg'"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class="col-md-4 col-6 pl-2 pr-0 pb-0"><a
                                                        href="javascript:void();"><img
                                                            :src="'/storage/assets/images/page-img/g9.jpg'"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div id="post-modal-data" class="iq-card">
                                        ...
                                        <div class="iq-card-body" data-toggle="modal" data-target="#post-modal">
                                            <div class="d-flex align-items-center">
                                                <div class="user-img">
                                                    <img :src="'/storage/assets/images/user/1.jpg'" alt="userimg"
                                            ...
                                            <ul class="post-opt-block d-flex align-items-center list-inline m-0 p-0">
                                                <li class="iq-bg-primary rounded p-2 pointer mr-3"><a href="#"></a><img
                                                        :src="'/storage/assets/images/small/07.png'" alt="icon"
                                                        class="img-fluid">
                                                    Photo/Video</li>
                                                <li class="iq-bg-primary rounded p-2 pointer mr-3"><a href="#"></a><img
                                                        :src="'/storage/assets/images/small/08.png'" alt="icon"
                                                        class="img-fluid"> Tag
                                                    Friend</li>
                                                <li class="iq-bg-primary rounded p-2 pointer mr-3"><a href="#"></a><img
                                                        :src="'/storage/assets/images/small/09.png'" alt="icon"
                                                        class="img-fluid">
                                                    Feeling/Activity</li>
                                                <li class="iq-bg-primary rounded p-2 pointer">
                                                    <div class="iq-card-header-toolbar d-flex align-items-center">
                                                        <div class="dropdown">
                                                            <span class="dropdown-toggle" id="post-option"
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <button type="button" class="btn btn-secondary"
                                                            data-dismiss="modal"><i class="ri-close-fill"></i></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="d-flex align-items-center">
                                                            <div class="user-img">
                                                                <img :src="'/storage/assets/images/user/1.jpg'"
                                                                    alt="userimg"
                                                                    class="avatar-60 rounded-circle img-fluid">
                                                            </div>
                                                        ...
                                                        <ul
                                                            ...
                                                            <li class="col-md-6 mb-3">
                                                                <div class="iq-bg-primary rounded p-2 pointer mr-3"><a
                                                                        href="#"></a><img
                                                                        :src="'/storage/assets/images/small/07.png'"
                                                                        alt="icon" class="img-fluid"> Photo/Video</div>
                                                            </li>
                                                            <li class="col-md-6 mb-3">
                                                                <div class="iq-bg-primary rounded p-2 pointer mr-3"><a
                                                                        href="#"></a><img
                                                                        :src="'/storage/assets/images/small/08.png'"
                                                                        alt="icon" class="img-fluid"> Tag Friend</div>
                                                            </li>
                                                            <li class="col-md-6 mb-3">
                                                                <div class="iq-bg-primary rounded p-2 pointer mr-3"><a
                                                                        href="#"></a><img
                                                                        :src="'/storage/assets/images/small/09.png'"
                                                                        alt="icon" class="img-fluid"> Feeling/Activity
                                                                </div>
                                                            </li>
                                                            <li class="col-md-6 mb-3">
                                                                <div class="iq-bg-primary rounded p-2 pointer mr-3"><a
                                                                        href="#"></a><img
                                                                        :src="'/storage/assets/images/small/10.png'"
                                                                        alt="icon" class="img-fluid"> Check in</div>
                                                            </li>
                                                            <li class="col-md-6 mb-3">
                                                                <div class="iq-bg-primary rounded p-2 pointer mr-3"><a
                                                                        href="#"></a><img
                                                                        :src="'/storage/assets/images/small/11.png'"
                                                                        alt="icon" class="img-fluid"> Live Video</div>
                                                            </li>
                                                            <li class="col-md-6 mb-3">
                                                                <div class="iq-bg-primary rounded p-2 pointer mr-3"><a
                                                                        href="#"></a><img
                                                                        :src="'/storage/assets/images/small/12.png'"
                                                                        alt="icon" class="img-fluid"> Gif</div>
                                                            </li>
                                                            <li class="col-md-6 mb-3">
                                                                <div class="iq-bg-primary rounded p-2 pointer mr-3"><a
                                                                        href="#"></a><img
                                                                        :src="'/storage/assets/images/small/13.png'"
                                                                        alt="icon" class="img-fluid"> Watch Party</div>
                                                            </li>
                                                            <li class="col-md-6 mb-3">
                                                                <div class="iq-bg-primary rounded p-2 pointer mr-3"><a
                                                                        href="#"></a><img
                                                                        :src="'/storage/assets/images/small/14.png'"
                                                        ...
                                                        <div class="other-option">
                                                            <div
                                                                ...
                                                                <div class="iq-card-post-toolbar">
                                                                    <div class="dropdown">
                                                                        <span class="dropdown-toggle" id="postdata-1"
                                                                            data-toggle="dropdown" aria-haspopup="true"
                                                                            aria-expanded="false" role="button">
                                                                            <span class="btn btn-primary">Friend</span>
                                                                        </span>
                                                                        <div class="dropdown-menu m-0 p-0"
                                                                            aria-labelledby="postdata-1" style="">
                                    ...
                                    <div class="iq-card">
                                        <div class="iq-card-body">
                                            <div class="post-item">
                                                    ...
                                                    <div class="d-flex flex-wrap">
                                                        <div class="media-support-user-img mr-3">
                                                            <img class="rounded-circle img-fluid"
                                                                :src="'/storage/assets/images/user/1.jpg'" alt="">
                                                        </div>
                                                ...
                                                <div class="user-post">
                                                    <a href="javascript:void();"><img
                                                            :src="'/storage/assets/images/page-img/p1.jpg'"
                                                ...
                                                <div class="comment-area mt-3">
                                                                ...
                                                                <div class="like-data">
                                                                    <div class="dropdown">
                                                                        <span class="dropdown-toggle"
                                                                            data-toggle="dropdown" aria-haspopup="true"
                                                                            aria-expanded="false" role="button">
                                                                            <img :src="'/storage/assets/images/icon/01.png'"
                                                                                class="img-fluid" alt="">
                                                                        </span>
                                                                        <div class="dropdown-menu">
                                                                            <a class="ml-2 mr-2" href="#"
                                                                                ...
                                                                                data-original-title="Like"><img
                                                                                    :src="'/storage/assets/images/icon/01.png'"
                                                                                    class="img-fluid" alt=""></a>
                                                                            <a class="mr-2" href="#"
                                                                                data-toggle="tooltip"
                                                                                data-placement="top" title=""
                                                                                data-original-title="Love"><img
                                                                                    :src="'/storage/assets/images/icon/02.png'"
                                                                                    class="img-fluid" alt=""></a>
                                                                            <a class="mr-2" href="#"
                                                                                data-toggle="tooltip"
                                                                                data-placement="top" title=""
                                                                                data-original-title="Happy"><img
                                                                                    :src="'/storage/assets/images/icon/03.png'"
                                                                                    class="img-fluid" alt=""></a>
                                                                            <a class="mr-2" href="#"
                                                                                data-toggle="tooltip"
                                                                                data-placement="top" title=""
                                                                                data-original-title="HaHa"><img
                                                                                    :src="'/storage/assets/images/icon/04.png'"
                                                                                    class="img-fluid" alt=""></a>
                                                                            <a class="mr-2" href="#"
                                                                                data-toggle="tooltip"
                                                                                data-placement="top" title=""
                                                                                data-original-title="Think"><img
                                                                                    :src="'/storage/assets/images/icon/05.png'"
                                                                                    class="img-fluid" alt=""></a>
                                                                            <a class="mr-2" href="#"
                                                                                data-toggle="tooltip"
                                                                                data-placement="top" title=""
                                                                                data-original-title="Sade"><img
                                                                                    :src="'/storage/assets/images/icon/06.png'"
                                                                                    class="img-fluid" alt=""></a>
                                                                            <a class="mr-2" href="#"
                                                                                data-toggle="tooltip"
                                                                                data-placement="top" title=""
                                                                                data-original-title="Lovely"><img
                                                                                    :src="'/storage/assets/images/icon/07.png'"
                                                                                    class="img-fluid" alt=""></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <ul class="post-comments p-0 m-0">
                                                        <li class="mb-2">
                                                            <div class="d-flex flex-wrap">
                                                                <div class="user-img">
                                                                    <img :src="'/storage/assets/images/user/02.jpg'"
                                                                        alt="userimg"
                                                        ...
                                                        <li>
                                                            <div class="d-flex flex-wrap">
                                                                <div class="user-img">
                                                                    <img :src="'/storage/assets/images/user/03.jpg'"
                                                                        alt="userimg"
                                                                        class="avatar-35 rounded-circle img-fluid">
                                                                </div>
                                                                <div class="comment-data-block ml-3">
                                                    ...
                                                    <form class="comment-text d-flex align-items-center mt-3"
                                                        ...
                                                        <div class="comment-attagement d-flex">
                                                            <a href="javascript:void();"><i
                                                                    class="ri-link mr-3"></i></a>
                                                            <a href="javascript:void();"><i
                                                                    class="ri-user-smile-line mr-3"></i></a>
                                                            <a href="javascript:void();"><i
                                                                    class="ri-camera-line mr-3"></i></a>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                            <div class="post-item">
                                                <div class="user-post-data p-3">
                                                    <div class="d-flex flex-wrap">
                                                        ...
                                                        <div class="media-support-info mt-2">
                                                            <h5 class="mb-0 d-inline-block"><a href="#" class="">Bni
                                                                    Cyst</a></h5>
                                                            <p class="ml-1 mb-0 d-inline-block">Share Anna Mull's Post
                                                            </p>
                                                ...
                                                <div class="user-post">
                                                    <a href="javascript:void();"><img
                                                            :src="'/storage/assets/images/page-img/p3.jpg'"
                                                            alt="post-image" class="img-fluid w-100" /></a>
                                                </div>
                                                <div class="comment-area mt-3">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="user-post-data p-3">
                                                    <div class="d-flex flex-wrap">
                                                        ...
                                                        <div class="media-support-info mt-2">
                                                            <h5 class="mb-0 d-inline-block"><a href="#" class="">Bni
                                                                    Cyst</a></h5>
                                                            <p class="ml-1 mb-0 d-inline-block">Change Profile Picture
                                                            </p>
                            ...
                            <div class="iq-card-body">
                                ...
                                <div class="friend-list-tab mt-2">
                                    <ul
                                        ...
                                        <li>
                                            <a class="nav-link active" data-toggle="pill" href="#all-friends">All
                                                Friends</a>
                                        </li>
                                        <li>
                                            <a class="nav-link" data-toggle="pill" href="#recently-add">Recently
                                                Added</a>
                                        </li>
                                        <li>
                                            <a class="nav-link" data-toggle="pill" href="#closefriends">Close
                                                friends</a>
                                        </li>
                                        <li>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 mb-3">
                                                        <div class="iq-friendlist-block">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <a href="#">
                                                                        <img :src="'/storage/assets/images/user/06.jpg'"
                                                                            alt="profile-img" class="img-fluid">
                                                                    </a>
                                                                    <div class="friend-info ml-3">
                                                                        <h5>Anna Sthesia</h5>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 mb-3">
                                                        <div class="iq-friendlist-block">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <a href="#">
                                                                        <img :src="'/storage/assets/images/user/07.jpg'"
                                                                            alt="profile-img" class="img-fluid">
                                                                    </a>
                                                                    <div class="friend-info ml-3">
                                                                        <h5>Paul Molive</h5>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 mb-3">
                                                        <div class="iq-friendlist-block">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <a href="#">
                                                                        <img :src="'/storage/assets/images/user/08.jpg'"
                                                                            alt="profile-img" class="img-fluid">
                                                                    </a>
                                                                    <div class="friend-info ml-3">
                                                    ...
                                                    <div class="col-md-6 col-lg-6 mb-3">
                                                        <div class="iq-friendlist-block">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <a href="#">
                                                                        <img :src="'/storage/assets/images/user/09.jpg'"
                                                                            alt="profile-img" class="img-fluid">
                                                                    </a>
                                                                    <div class="friend-info ml-3">
                                                                        <h5>Paige Turner</h5>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 mb-3">
                                                        <div class="iq-friendlist-block">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <a href="#">
                                                                        <img :src="'/storage/assets/images/user/10.jpg'"
                                                                            alt="profile-img" class="img-fluid">
                                                                    </a>
                                                                    <div class="friend-info ml-3">
                                                                        <h5>b Frapples</h5>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 mb-3">
                                                        <div class="iq-friendlist-block">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <a href="#">
                                                                        <img :src="'/storage/assets/images/user/13.jpg'"
                                                                            alt="profile-img" class="img-fluid">
                                                                    </a>
                                                                    <div class="friend-info ml-3">
                                                                        <h5>Walter Melon</h5>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 mb-3">
                                                        <div class="iq-friendlist-block">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <a href="#">
                                                                        <img :src="'/storage/assets/images/user/14.jpg'"
                                                                            alt="profile-img" class="img-fluid">
                                                                    </a>
                                                                    <div class="friend-info ml-3">
                                                                        <h5>Barb Ackue</h5>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 mb-3">
                                                        <div class="iq-friendlist-block">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <a href="#">
                                                                        <img :src="'/storage/assets/images/user/15.jpg'"
                                                                            alt="profile-img" class="img-fluid">
                                                                    </a>
                                                                    <div class="friend-info ml-3">
                                                                        <h5>Buck Kinnear</h5>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 mb-3">
                                                        <div class="iq-friendlist-block">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <a href="#">
                                                                        <img :src="'/storage/assets/images/user/16.jpg'"
                                                                            alt="profile-img" class="img-fluid">
                                                                    </a>
                                                                    <div class="friend-info ml-3">
                                                                        <h5>Ira Membrit</h5>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 mb-3">
                                                        <div class="iq-friendlist-block">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <a href="#">
                                                                        <img :src="'/storage/assets/images/user/17.jpg'"
                                                                            alt="profile-img" class="img-fluid">
                                                                    </a>
                                                                    <div class="friend-info ml-3">
                                                                        <h5>Shonda Leer</h5>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 mb-3">
                                                        <div class="iq-friendlist-block">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <a href="#">
                                                                        <img :src="'/storage/assets/images/user/18.jpg'"
                                                                            alt="profile-img" class="img-fluid">
                                                                    </a>
                                                                    <div class="friend-info ml-3">
                                                                        <h5>ock Lee</h5>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 mb-3">
                                                        <div class="iq-friendlist-block">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <a href="#">
                                                                        <img :src="'/storage/assets/images/user/19.jpg'"
                                                                            alt="profile-img" class="img-fluid">
                                                                    </a>
                                                                    <div class="friend-info ml-3">
                                                                        <h5>Maya Didas</h5>
                            ...
                            <div class="iq-card-body">
                                ...
                                <div class="friend-list-tab mt-2">
                                    <ul
                                        class="nav nav-pills d-flex align-items-center justify-content-left friend-list-items p-0 mb-2">
                                        <li>
                                            <a class="nav-link active" data-toggle="pill" href="#photosofyou">Photos of
                                                You</a>
                                        </li>
                                        <li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-lg-3 mb-3">
                                                        <div class="user-images position-relative overflow-hidden">
                                                            <a href="#">
                                                                <img :src="'/storage/assets/images/page-img/51.jpg'"
                                                    ...
                                                    <div class="col-md-6 col-lg-3 mb-3">
                                                        <div class="user-images position-relative overflow-hidden">
                                                            <a href="#">
                                                                <img :src="'/storage/assets/images/page-img/52.jpg'"
                                                                    class="img-fluid rounded" alt="Responsive image">
                                                            </a>
                                                            <div class="image-hover-data">
                                                                <div class="product-elements-icon">
                                                    ...
                                                    <div class="col-md-6 col-lg-3 mb-3">
                                                        <div class="user-images position-relative overflow-hidden">
                                                            <a href="#">
                                                                <img :src="'/storage/assets/images/page-img/53.jpg'"
                                                                    class="img-fluid rounded" alt="Responsive image">
                                                            </a>
                                                            <div class="image-hover-data">
                                                                <div class="product-elements-icon">
                                                    ...
                                                    <div class="col-md-6 col-lg-3 mb-3">
                                                        <div class="user-images position-relative overflow-hidden">
                                                            <a href="#">
                                                                <img :src="'/storage/assets/images/page-img/54.jpg'"
                                                                    class="img-fluid rounded" alt="Responsive image">
                                                            </a>
                                                            <div class="image-hover-data">
                                                                <div class="product-elements-icon">
                                                    ...
                                                    <div class="col-md-6 col-lg-3 mb-3">
                                                        <div class="user-images position-relative overflow-hidden">
                                                            <a href="#">
                                                                <img :src="'/storage/assets/images/page-img/55.jpg'"
                                                                    class="img-fluid rounded" alt="Responsive image">
                                                            </a>
                                                            <div class="image-hover-data">
                                                                <div class="product-elements-icon">
                                                    ...
                                                    <div class="col-md-6 col-lg-3 mb-3">
                                                        <div class="user-images position-relative overflow-hidden">
                                                            <a href="#">
                                                                <img :src="'/storage/assets/images/page-img/56.jpg'"
                                                                    class="img-fluid rounded" alt="Responsive image">
                                                            </a>
                                                            <div class="image-hover-data">
                                                                <div class="product-elements-icon">
                                                    ...
                                                    <div class="col-md-6 col-lg-3 mb-3">
                                                        <div class="user-images position-relative overflow-hidden">
                                                            <a href="#">
                                                                <img :src="'/storage/assets/images/page-img/57.jpg'"
                                                                    class="img-fluid rounded" alt="Responsive image">
                                                            </a>
                                                            <div class="image-hover-data">
                                                                <div class="product-elements-icon">
                                                    ...
                                                    <div class="col-md-6 col-lg-3 mb-3">
                                                        <div class="user-images position-relative overflow-hidden">
                                                            <a href="#">
                                                                <img :src="'/storage/assets/images/page-img/58.jpg'"
                                                                    class="img-fluid rounded" alt="Responsive image">
                                                            </a>
                                                            <div class="image-hover-data">
                                                                <div class="product-elements-icon">
                                                    ...
                                                    <div class="col-md-6 col-lg-3 mb-3">
                                                        <div class="user-images position-relative overflow-hidden">
                                                            <a href="#">
                                                                <img :src="'/storage/assets/images/page-img/59.jpg'"
                                                                    class="img-fluid rounded" alt="Responsive image">
                                                            </a>
                                                            <div class="image-hover-data">
                                                                <div class="product-elements-icon">
                                                    ...
                                                    <div class="col-md-6 col-lg-3 mb-3">
                                                        <div class="user-images position-relative overflow-hidden">
                                                            <a href="#">
                                                                <img :src="'/storage/assets/images/page-img/60.jpg'"
                                                                    class="img-fluid rounded" alt="Responsive image">
                                                            </a>
                                                            <div class="image-hover-data">
                                                                <div class="product-elements-icon">
                                                    ...
                                                    <div class="col-md-6 col-lg-3 mb-3">
                                                        <div class="user-images position-relative overflow-hidden">
                                                            <a href="#">
                                                                <img :src="'/storage/assets/images/page-img/61.jpg'"
                                                                    class="img-fluid rounded" alt="Responsive image">
                                                            </a>
                                                            <div class="image-hover-data">
                                                                <div class="product-elements-icon">
                                                    ...
                                                    <div class="col-md-6 col-lg-3 mb-3">
                                                        <div class="user-images position-relative overflow-hidden">
                                                            <a href="#">
                                                                <img :src="'/storage/assets/images/page-img/62.jpg'"
                                                                    class="img-fluid rounded" alt="Responsive image">
                                                            </a>
                                                            <div class="image-hover-data">
                                                                <div class="product-elements-icon">
                                                    ...
                                                    <div class="col-md-6 col-lg-3 mb-3">
                                                        <div class="user-images position-relative overflow-hidden">
                                                            <a href="#">
                                                                <img :src="'/storage/assets/images/page-img/63.jpg'"
                                                                    class="img-fluid rounded" alt="Responsive image">
                                                            </a>
                                                            <div class="image-hover-data">
                                                                <div class="product-elements-icon">
                                                    ...
                                                    <div class="col-md-6 col-lg-3 mb-3">
                                                        <div class="user-images position-relative overflow-hidden">
                                                            <a href="#">
                                                                <img :src="'/storage/assets/images/page-img/64.jpg'"
                                                                    class="img-fluid rounded" alt="Responsive image">
                                                            </a>
                                                            <div class="image-hover-data">
                                                                <div class="product-elements-icon">
                                                    ...
                                                    <div class="col-md-6 col-lg-3 mb-3">
                                                        <div class="user-images position-relative overflow-hidden">
                                                            <a href="#">
                                                                <img :src="'/storage/assets/images/page-img/65.jpg'"
                                                                    class="img-fluid rounded" alt="Responsive image">
                                                            </a>
                                                            <div class="image-hover-data">
                                                                <div class="product-elements-icon">
