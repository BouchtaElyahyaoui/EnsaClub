                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><img
                                                    src="{{asset('storage/img/90x90.jpg')}}" alt="avatar">Irene Collins
                                            </div>
                                        </td>
                                        <td>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content product-name"><img
                                                    src="{{asset('storage/img/90x90.jpg')}}" alt="product">Laptop</div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content product-name"><img
                                                    src="{{asset('storage/img/90x90.jpg')}}" alt="product">Camera</div>
                                        </td>
                                        <td>
